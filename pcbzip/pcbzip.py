...
if __name__ == "__main__":
    ...
    try:
        ...
        parser.add_argument("--no_assy",            help="In adition to the gerber files process the BOM and component placement files for PCB assembly.", action="store_true")
